...
S({
  ...
  plus:{titre:'Le tracé d\'Eyring sur tes trois points — et ce qu\'il révèle',
    body:'<p>On part de ΔΔG‡ = ΔΔH‡ − T·ΔΔS‡ et de ln(e.r.) = ΔΔG‡/RT. En combinant :</p>'
      ...
      +'<p><i>Les trois points sont ceux de tes notes ; la régression et son interprétation sont un ajout, à vérifier avec ton enseignant si tu veux t\'en servir. La formule qui estime les <b>durées</b> est purement empirique et bien moins fidèle : elle sert à faire varier le curseur, pas à prédire un temps de réaction.</i>'},
  quiz:{q:'On veut un e.e. d\'au moins 90 %. Quelle température choisir, et combien de temps faudra-t-il&nbsp;?',
        a:'Un e.e. de 90 % correspond à un e.r. de 95 : 5, donc ln(e.r.) = 2,944. Avec ln(e.r.) = 1336/T − 2,636, on trouve T = 1336/5,580 = 239 K, soit environ <b>−34 °C</b>. La durée estimée par le curseur est alors d\'environ <b>17 h</b>. La ligne mesurée la plus proche (−30 °C, 24 h) donne le même ordre de grandeur : l\'ajustement des <i>durées</i> est nettement moins bon que celui des sélectivités, parce que trois points ne suffisent pas à décrire une cinétique.'}
});
